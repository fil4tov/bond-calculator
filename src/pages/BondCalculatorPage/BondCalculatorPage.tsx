    ...
    <main className={styles.pageShell}>
      <header className={styles.hero}>
        <div className={styles.heroToolbar}>
          <div className={styles.eyebrow}><span aria-hidden="true" /> ОБЛИГАЦИИ</div>
          <div className={styles.heroActions}>
            ...
            <IconButton icon={theme === 'dark' ? <FiSun /> : <FiMoon />} type="button" aria-label={theme === 'dark' ? 'Включить светлую тему' : 'Включить тёмную тему'} aria-pressed={theme === 'dark'} onClick={toggleTheme} />
          </div>
        </div>
